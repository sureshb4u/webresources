...
function ResourceView(element, calendar, viewName) {
    ...
    function updateCells() {
        ...
        for (i=0; i<colCnt; i++) {
            ...
            headCell.html(resources[i].capacity != undefined ? resources[i].name+" ("+resources[i].capacity+")" : resources[i].name);
...
function AgendaView(element, calendar, viewName) {
	...
	function buildSkeleton() {
		...
		slotScroller =
			$("<div class='weekscroller' style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>")
				.appendTo(slotLayer);
